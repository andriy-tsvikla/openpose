...
function(op_detect_installed_gpus out_variable)
  ...
  #endif ()
  message(STATUS "Cuda.cmake out_variable ${out_variable}")
  set(${out_variable} sm_75 PARENT_SCOPE)
endfunction()
...
function(op_select_nvcc_arch_flags out_variable)
  ...
  set(__archs_name_default "Turing (CUDA >= 10)")
  if (NOT CMAKE_CROSSCOMPILING)
    message(STATUS "if (NOT CMAKE_CROSSCOMPILING)")
